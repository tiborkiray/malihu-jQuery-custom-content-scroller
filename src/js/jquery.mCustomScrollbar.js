...
$.fn.mCustomScrollbar = function (options){
	...
	this.each(function(){
		...
		var $customScrollBox_content=$me.find(".customScrollBox .content");
		var $dragger_container=$me.find(".dragger_container");
		var $dragger=$me.find(".dragger");
		var $scrollUpBtn=$me.find(".scrollUpBtn");
		var $scrollDownBtn=$me.find(".scrollDownBtn");
		var $customScrollBox_horWrapper=$me.find(".customScrollBox .horWrapper");
		...
		function PrepareCustomScrollBar() {
			$me.addClass("content");

			if (options.scrollType == 'horizontal')
				$me.wrap($('<div><div class="customScrollBox"><div class="horWrapper"><div class="container">'));
			else
				$me.wrap($('<div><div class="customScrollBox"><div class="container">'));
			
			$me.parent().parent().append($('<div class="dragger_container"><div class="dragger">'));
			
			return $me.parents('.customScrollBox').parent();
		};
			...
			//vertical scrolling ------------------------------
				...
				if($customScrollBox_container.height()>visibleHeight){ //enable scrollbar if content is long
					...
					function Scroll(){
						...
						$customScrollBox_container.stop().animate({top: "-="+thePos}, options.animSpeed, options.easeType);
					}
				} else { //disable scrollbar if content is short
